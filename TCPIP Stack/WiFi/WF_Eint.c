 ...
 *****************************************************************************/
//extern void __attribute((interrupt(ipl3), vector(_EXTERNAL_3_VECTOR), nomips16)) vINT3InterruptWrapper(void);
//
//void vINT3InterruptHandler(void)
extern void __attribute((interrupt(ipl3), vector(_EXTERNAL_3_VECTOR), nomips16)) vINT3InterruptWrapper(void)
{
    // clear EINT
